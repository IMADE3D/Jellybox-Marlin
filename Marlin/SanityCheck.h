...
#elif defined(PET_PREHEAT_HOTEND_TEMP)
  #error "PET_PREHEAT_HOTEND_TEMP is now PREHEAT_3_TEMP_HOTEND. Please update your configuration."
#elif defined(PET_PREHEAT_HPB_TEMP)
  #error "PET_PREHEAT_HPB_TEMP is now PREHEAT_3_TEMP_BED. Please update your configuration."
#elif defined(PET_PREHEAT_FAN_SPEED)
  #error "PET_PREHEAT_FAN_SPEED is now PREHEAT_3_FAN_SPEED. Please update your configuration."
#elif defined(FLEX_PREHEAT_HOTEND_TEMP)
  #error "FLEX_PREHEAT_HOTEND_TEMP is now PREHEAT_4_TEMP_HOTEND. Please update your configuration."
#elif defined(FLEX_PREHEAT_HPB_TEMP)
  #error "FLEX_PREHEAT_HPB_TEMP is now PREHEAT_4_TEMP_BED. Please update your configuration."
#elif defined(FLEX_PREHEAT_FAN_SPEED)
  #error "FLEX_PREHEAT_FAN_SPEED is now PREHEAT_4_FAN_SPEED. Please update your configuration."
