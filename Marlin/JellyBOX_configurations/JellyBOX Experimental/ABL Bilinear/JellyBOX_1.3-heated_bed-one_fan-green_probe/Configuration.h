...
#define JELLYBOX_VARIANT_LINE2 "bed, one fan, green"
/**
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (LEFT_PROBE_BED_POSITION) // ((X_BED_SIZE) / 2)    // X point for Z homing when homing all axes (G28).
