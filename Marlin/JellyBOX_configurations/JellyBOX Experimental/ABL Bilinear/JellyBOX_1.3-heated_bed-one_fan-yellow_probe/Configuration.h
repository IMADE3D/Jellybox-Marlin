#define JELLYBOX_VARIANT_LINE1 "JellyBOX 1.3, hot"
#define JELLYBOX_VARIANT_LINE2 "bed, one fan, yellow"
/**
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (X_PROBE_OFFSET_FROM_EXTRUDER / 3) // ((X_BED_SIZE) / 2)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT (MIN_PROBE_EDGE + Y_PROBE_OFFSET_FROM_EXTRUDER) // ((Y_BED_SIZE) / 2)    // Y point for Z homing when homing all axes (G28).
#endif
