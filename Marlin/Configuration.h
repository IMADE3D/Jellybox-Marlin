...
#define STRING_SPLASH_LINE1 GREETING // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 SHORT_BUILD_VERSION_IM3D STRING_DISTRIBUTION_DATE_IM3D         // will be shown during bootup in line 2
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  #define K1 1.5 //smoothing factor within the PID
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (17) // ((X_MIN_POS + X_MAX_POS) / 2)    // X point for Z homing when homing all axis (G28).
